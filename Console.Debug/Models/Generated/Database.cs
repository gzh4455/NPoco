...
//     Connection String:      `Data Source=GAN-PC\SQLEXPRESS;Initial Catalog=NorthWind;User ID=sa;Password=sa`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace NorthWind
{
    ...
    public partial class Permission : NorthWindDB.Record<Permission>  
    {



		[Column] public string PermissionId { get; set; }





		[Column] public string PermissionLevel { get; set; }
    ...
    public partial class User : NorthWindDB.Record<User>  
    {
		...
		[Column] public string HomeAddress { get; set; }
